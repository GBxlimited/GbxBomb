...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/GBxlimited/GbxBomb/archive/dev.zip"
        dir_name = "GbxBomb-dev"
    else:
        zip_url = "https://github.com/GBxlimited/GbxBomb/archive/master.zip"
        dir_name = "GbxBomb-master"
    ...
    if success:
        mesgdcrt.SuccessMessage("GBxBomb was updated to the latest version")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/GBxlimited/GbxBomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/GBxlimited/GbxBomb/master/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("GBxBomb is up-to-date")
        mesgdcrt.GeneralMessage("Starting GBxBomb")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/GBxlimited/GbxBomb/raw/dev/.notify"
        else:
            url = "https://github.com/GBxlimited/GbxBomb/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("GBxBomb was created by GBxlimited")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("GBxBomb will work only in Python v3")
    sys.exit()
...
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start GBxBomb with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start GBxBomb with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start GBxBomb with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update GBxBomb")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current GBxBomb contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current GBxBomb version")
